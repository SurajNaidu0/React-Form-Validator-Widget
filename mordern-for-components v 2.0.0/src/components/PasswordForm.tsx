...
export function PasswordForm({heading, value, onChange, error }: PasswordFormProps) {
            ...
            <div className="w-full relative group">
                <div className="relative">
                    <input
                        ...
                        className={`w-full p-2 pl-3 pr-10 bg-transparent border-2 rounded-md outline-none transition-all duration-300 ${
                            isFocused ? "border-pink-500" : "border-gray-200"
                        } focus:border-pink-500 ${error ? "border-red-500" : ""}`}
