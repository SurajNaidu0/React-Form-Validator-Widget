...
function PasswordForm(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "flex flex-col items-center p-6 rounded-lg w-full bg-white relative overflow-hidden shadow-[0_0_0_1px_rgba(0,0,0,0.1)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(255,255,255,0.5)] transition-shadow duration-500" }, { children: [jsxRuntime.jsx("h2", __assign({ className: "text-xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-purple-500 transform transition-transform duration-300" }, { children: heading })), jsxRuntime.jsxs("div", __assign({ className: "w-full relative group" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "relative" }, { children: [jsxRuntime.jsx("input", { type: showPassword ? "text" : "password", value: value, onChange: function (e) { return onChange(e.target.value); }, onFocus: function () { return setIsFocused(true); }, onBlur: function () { return setIsFocused(false); }, className: "w-full p-2 pl-3 pr-10 bg-transparent border-2 rounded-md outline-none transition-all duration-300 ".concat(isFocused ? "border-pink-500" : "border-gray-200", " focus:border-pink-500 ").concat(error ? "border-red-500" : ""), placeholder: "Enter your password" }), jsxRuntime.jsx("button", __assign({ type: "button", onClick: function () { return setShowPassword(!showPassword); }, className: "absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-pink-500 transition-colors duration-300" }, { children: showPassword ? "🙈" : "👁️" }))] })), jsxRuntime.jsxs("div", __assign({ className: "mt-4 space-y-2" }, { children: [jsxRuntime.jsx("div", __assign({ className: "flex gap-2" }, { children: [1, 2, 3, 4].map(function (level) { return (jsxRuntime.jsx("div", { className: "h-2 flex-1 rounded-full transition-all duration-500 ".concat(strength >= level ? getStrengthColor() : "bg-gray-200") }, level)); }) })), jsxRuntime.jsx("p", __assign({ className: "text-sm transition-colors duration-300 ".concat(strength === 0
                                    ? "text-gray-400"
                                    : strength === 1
                                        ? "text-red-500"
                                        : strength === 2
                        ...
                        }) })), error && jsxRuntime.jsx("p", __assign({ className: "text-red-500 text-sm mt-2" }, { children: error }))] })), jsxRuntime.jsx("div", __assign({ className: "absolute inset-0 pointer-events-none" }, { children: jsxRuntime.jsx("div", { className: "absolute w-full h-full bg-[radial-gradient(circle,_transparent_10%,_#fff_70%)] opacity-0 group-hover:opacity-100 transition-opacity duration-700 scale-150 group-hover:scale-100" }) }))] })));
}
...
function EmailForm(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "flex flex-col items-center p-6 rounded-lg w-full bg-white relative overflow-hidden shadow-[0_0_0_1px_rgba(0,0,0,0.1)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(255,255,255,0.5)] transition-shadow duration-500" }, { children: [jsxRuntime.jsx("h2", __assign({ className: "text-xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-purple-500 transform transition-transform duration-300" }, { children: heading })), jsxRuntime.jsxs("div", __assign({ className: "w-full relative group" }, { children: [jsxRuntime.jsx("label", __assign({ className: "absolute left-3 pointer-events-none transition-all duration-300 origin-left ".concat(isFocused || value
                            ? "transform -translate-y-6 scale-75 text-pink-500"
                            : "transform translate-y-2 text-gray-400") }, { children: "Email address" })), jsxRuntime.jsx("input", { type: "email", value: value, onChange: handleChange, onFocus: function () { return setIsFocused(true); }, onBlur: function () { return setIsFocused(false); }, onClick: triggerRipple, className: "w-full p-2 bg-transparent border-b-2 outline-none transition-all duration-300 ".concat(isFocused ? "border-pink-500" : "border-gray-200", " ").concat((!isValid && hasInteracted) || error ? "border-red-500" : "", " focus:border-pink-500 ").concat(rippleEffect ? "animate-pulse" : "") }), jsxRuntime.jsx("div", { className: "absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-pink-500 to-purple-500 transition-all duration-300 ease-out ".concat(isFocused ? "w-full" : "w-0", " ").concat((!isValid && hasInteracted) || error ? "bg-red-500" : "") }), jsxRuntime.jsx("div", { className: "absolute top-0 right-0 w-2 h-2 border-t-2 border-r-2 ".concat((!isValid && hasInteracted) || error ? "border-red-500" : "border-pink-500", " transition-all duration-300 opacity-0 ").concat(isFocused ? "opacity-100" : "") }), jsxRuntime.jsx("div", { className: "absolute bottom-0 left-0 w-2 h-2 border-b-2 border-l-2 ".concat((!isValid && hasInteracted) || error ? "border-red-500" : "border-pink-500", " transition-all duration-300 opacity-0 ").concat(isFocused ? "opacity-100" : "") }), jsxRuntime.jsx("p", __assign({ className: "absolute -bottom-6 left-0 text-sm transition-all duration-300 ".concat((!isValid && hasInteracted) || error
                            ? "text-red-500 opacity-100 translate-y-0"
                            : "opacity-0 -translate-y-2") }, { children: error || "Please enter a valid email address" }))] })), jsxRuntime.jsx("div", __assign({ className: "absolute right-4 top-1/2 -translate-y-1/2 transition-all duration-300 ".concat(isValid && hasInteracted && value ? "opacity-100 scale-100" : "opacity-0 scale-0") }, { children: jsxRuntime.jsx("svg", __assign({ className: "w-6 h-6 text-green-500", fill: "none", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", viewBox: "0 0 24 24", stroke: "currentColor" }, { children: jsxRuntime.jsx("path", { d: "M5 13l4 4L19 7" }) })) })), jsxRuntime.jsx("div", __assign({ className: "absolute inset-0 pointer-events-none" }, { children: jsxRuntime.jsx("div", { className: "absolute w-full h-full bg-[radial-gradient(circle,_transparent_10%,_#fff_70%)] opacity-0 group-hover:opacity-100 transition-opacity duration-700 scale-150 group-hover:scale-100" }) }))] })));
}
...
function FormWithOptions(_a) {
    ...
    var _c = react.useState(false), setRippleEffect = _c[1];
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "flex flex-col items-center p-6 rounded-lg w-full bg-white relative overflow-hidden shadow-[0_0_0_1px_rgba(0,0,0,0.1)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(255,255,255,0.5)] transition-shadow duration-500" }, { children: [jsxRuntime.jsx("h2", __assign({ className: "text-xl font-semibold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-purple-500 transition-transform duration-300" }, { children: heading })), jsxRuntime.jsx("div", __assign({ className: "w-full mb-4 grid grid-cols-2 gap-4" }, { children: options.map(function (option) { return (jsxRuntime.jsxs("div", __assign({ className: "flex items-center relative group" }, { children: [jsxRuntime.jsx("input", { type: "checkbox", id: option, value: option, onChange: function () {
                                ...
                                triggerRipple();
                            }, checked: value.includes(option), disabled: value.length >= maxSelection && !value.includes(option), className: "hidden" }), jsxRuntime.jsx("label", __assign({ htmlFor: option, className: "p-2 rounded-md cursor-pointer transition-all border-2 w-full text-center ".concat(value.includes(option)
                                ? "bg-gradient-to-r from-pink-500 to-purple-500 text-white border-transparent"
                                : "text-gray-600 border-gray-300", " ").concat(value.length >= maxSelection && !value.includes(option)
                                ? "opacity-50 cursor-not-allowed"
                                : "hover:scale-105 hover:shadow-md") }, { children: option }))] }), option)); }) })), error && jsxRuntime.jsx("p", __assign({ className: "text-red-500 mt-2" }, { children: error })), jsxRuntime.jsx("div", __assign({ className: "absolute inset-0 pointer-events-none" }, { children: jsxRuntime.jsx("div", { className: "absolute w-full h-full bg-[radial-gradient(circle,_transparent_10%,_#fff_70%)] opacity-0 group-hover:opacity-100 transition-opacity duration-700 scale-150 group-hover:scale-100" }) }))] })));
}

function DropDownForm(_a) {
    var heading = _a.heading, options = _a.options, value = _a.value, onChange = _a.onChange, error = _a.error;
    var _b = react.useState(false), rippleEffect = _b[0], setRippleEffect = _b[1];
    var handleChange = function (event) {
        onChange(event.target.value);
        triggerRipple();
    };
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "flex flex-col items-center p-6 rounded-lg w-full bg-white relative overflow-hidden shadow-[0_0_0_1px_rgba(0,0,0,0.1)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.1),inset_0_0_0_1px_rgba(255,255,255,0.5)] transition-shadow duration-500" }, { children: [jsxRuntime.jsx("h2", __assign({ className: "text-xl font-semibold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-purple-500 transition-transform duration-300" }, { children: heading })), jsxRuntime.jsx("div", __assign({ className: "relative w-full" }, { children: jsxRuntime.jsxs("select", __assign({ value: value, onChange: handleChange, className: "w-full p-2 rounded-md border-2 bg-white text-gray-700 border-gray-300 transition-all duration-300 focus:border-pink-500 focus:ring-2 focus:ring-purple-300 ".concat(rippleEffect ? "animate-pulse" : "", " ").concat(error ? "border-red-500" : "") }, { children: [jsxRuntime.jsx("option", __assign({ value: "", disabled: true }, { children: "Select an option" })), options.map(function (option) { return (jsxRuntime.jsx("option", __assign({ value: option }, { children: option }), option)); })] })) })), error && jsxRuntime.jsx("p", __assign({ className: "text-red-500 mt-2" }, { children: error })), jsxRuntime.jsx("div", __assign({ className: "absolute inset-0 pointer-events-none" }, { children: jsxRuntime.jsx("div", { className: "absolute w-full h-full bg-[radial-gradient(circle,_transparent_10%,_#fff_70%)] opacity-0 hover:opacity-100 transition-opacity duration-700 scale-150 hover:scale-100" }) }))] })));
}
...
var ConfigComponent = function (_a) {
    ...
    var renderFormComponent = function (form, index) {
        switch (form.type) {
            case "text":
                return (jsxRuntime.jsx(EnterFormBar, { heading: form.heading, value: formData[form.heading] || "", onChange: function (value) { return handleChange(form.heading, value); }, error: errors[form.heading] }, index));
            case "password":
                return (jsxRuntime.jsx(PasswordForm, { heading: form.heading, value: formData[form.heading] || "", onChange: function (value) { return handleChange(form.heading, value); }, error: errors[form.heading] }, index));
            case "email":
                return (jsxRuntime.jsx(EmailForm, { heading: form.heading, value: formData[form.heading] || "", onChange: function (value) { return handleChange(form.heading, value); }, error: errors[form.heading] }, index));
            case "options":
                return (jsxRuntime.jsx(FormWithOptions, { heading: form.heading, options: form.options || [], maxSelection: form.maxSelection, value: formData[form.heading] || "", onChange: function (value) { return handleChange(form.heading, value); }, error: errors[form.heading] }, index));
            case "dropdown":
                return (jsxRuntime.jsx(DropDownForm, { heading: form.heading, options: form.options || [], value: formData[form.heading] || "", onChange: function (value) { return handleChange(form.heading, value); }, error: errors[form.heading] }, index));
            case "date":
                return (jsxRuntime.jsx(DateSelectorForm, { heading: form.heading, value: formData[form.heading] || "", onChange: function (value) { return handleChange(form.heading, value); }, error: errors[form.heading] }, index));
            default:
                return null;
        }
    };
    return (jsxRuntime.jsx("div", __assign({ className: "flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-pink-50 to-purple-50 p-4" }, { children: jsxRuntime.jsxs("div", __assign({ className: "w-full max-w-2xl space-y-6" }, { children: [config.map(function (form, index) { return renderFormComponent(form, index); }), jsxRuntime.jsx(ButtonComponent, { onClick: handleSubmit })] })) })));
};
